 ...
 */
export type UserLeaderboardSchema = {
  /**
   * Username
   */
  username: string;
...
export type UsersApiGetLeaderboardResponses = {
   ...
   * OK
   */
  200: Array<UserLeaderboardSchema>;
};

export type UsersApiGetLeaderboardResponse =
  UsersApiGetLeaderboardResponses[keyof UsersApiGetLeaderboardResponses];
